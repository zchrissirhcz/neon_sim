...
static void readImageData(const char* filename, png_bytep* data, size_t* w, size_t* h);
static void writeImageData(const char* filename, png_bytep data, size_t w, size_t h ,size_t bitdepth);
